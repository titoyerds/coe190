...
def test_model(test_loader, model, num_classes, k=2):
...
if __name__ == '__main__':
    # Data Preparation
    test_loader = prepare_test_dataset(test_dir='data/custom/test', input_size=(512,512), batch_size=32) 
    
    # Testing 
    model = YOLO("runs/classify/train/weights/best.pt")  
    test_model(test_loader, model, num_classes=3, k=2)