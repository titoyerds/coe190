...
if __name__ == "__main__":
    ...
    train_loader, val_loader, _ = prepare_custom_dataset(input_size=(512, 512), batch_size=16, train_dir='./data/custom/train', val_dir='./data/custom/val', test_dir='./data/custom/test')


    # Training
    history = train_model(train_loader, val_loader, num_classes=3, epochs=20)